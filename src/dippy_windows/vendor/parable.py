# vendored from https://github.com/ldayton/Dippy
# source: src/dippy/vendor/parable.py
# synced-from-commit: ae0781f
# run: python scripts/sync_parable.py  to check for updates
